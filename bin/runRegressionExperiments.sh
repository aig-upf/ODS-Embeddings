      ...
      do
        ...
        do
          ...
          do
            ...
            REGRESSION_COMMANDS="$REGRESSION_COMMAND '$TARGET_DIR/emb/$TARGET_EMB' '$GRAPH_PATH$GRAPH_NAME-C$GRAPH_FORMAT' '$TARGET_DIR/labels/$TARGET_ENC'; $REGRESSION_COMMANDS"
          done
